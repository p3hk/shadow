...
bool RBX::load_game_data()
{
    ...
    RBX::Instance cameraInstance = Instance2.GetCameraInstance();
    std::string logMsgCamera = "Camera Found At: " + std::to_string(cameraInstance.address);
    RBX::Log_System::Info(logMsgCamera);
